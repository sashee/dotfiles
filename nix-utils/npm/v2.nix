...
export ${consts.SKIP_SANDBOX_ENV_VAR_NAME}="true"
	...
	npm_scripts = (import ../wrapper2.nix {
		name = "npm";
		inherit pkgs;
	...
	node_scripts = (import ../wrapper2.nix {
		name = "node";
		inherit pkgs;
	...
	node_nonet_scripts = (import ../wrapper2.nix {
		name = "node-nonet";
		inherit pkgs;
		bin = "${pkgs.nodePackages_latest.nodejs}/bin/node";
	...
	npx_scripts = (import ../wrapper2.nix {
		name = "npx";
		inherit pkgs;
	...
	npx_fullnet_scripts = (import ../wrapper2.nix {
		name = "npx-fullnet";
		inherit pkgs;
		bin = "${pkgs.nodePackages_latest.nodejs}/bin/npx";
